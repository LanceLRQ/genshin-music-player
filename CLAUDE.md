...
- [ ] Windows 真机验证：无游戏链路层完成（2026-09-18），游戏内 windsong-lyre 全套完成（2026-09-19：计时/MIDI 实奏/逐乐器校准与写回，发现普通权限注入被内核过滤、须管理员运行——README 已说明）；其余 4 件乐器游戏内用例、§5/§6 乐器信息、UAC 提权项待续
