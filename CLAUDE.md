...
- [ ] Windows 真机验证：无游戏链路层完成（2026-09-18），游戏内 12 件乐器 11 件完成（2026-09-19：计时/MIDI 实奏/逐乐器校准与写回——诗琴类 75ms、鼓与和弦吉他 96ms、晚风圆号 120ms；荒泷鼓/晚风圆号/聚聚鼓键位按玩家现场报告修正；发现普通权限注入被内核过滤、须管理员运行——README 已说明）；沃雅妮莎未上线跳过；音高录音定标（§5.3/§6.1/新乐器）、§7.2 应用层恢复听感、UAC 提权项待续
